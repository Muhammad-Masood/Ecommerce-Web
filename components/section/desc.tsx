...
const Desc = ({ descImage }: { descImage: PImage }) => {
  return (
    <div className="relative">
      ...
      <div className={`bg-slate-50  lg:px-[8rem] md:px-[4rem] sm:px-[2rem]  pt-[7rem] pb-[3.8rem]`}>
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:space-y-0 sm:space-y-[4rem] lg:px-0 px-[2rem] lg:pt-0 pt-[4rem] gap-x-[6rem] gap-y-[2rem]">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-x-[6rem] ${sora_light.className} `}>
          {/* <div> */}
            <Image
          ...
          <div className="space-y-5 pt-4 max-w-max ">
            <p style={{ wordSpacing: "0.8rem" }}  className={` opacity-75 leading-[1.4rem] ${sora_light.className}`}>
